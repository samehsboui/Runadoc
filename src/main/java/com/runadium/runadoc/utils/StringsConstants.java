package com.runadium.runadoc.utils;
...
public class StringsConstants {
	...
	public static final String[] CSRF_IGNORE = { "/api/auth/**", "/api/password/**", "/api/profile/**", "/api/user/**",
			"/api/etablissements/**", "/api/rendezvous/**" };
	...
	public static final String RENDEZVOUS_URL = "/api/terrain";
	public static final String ETABLISSEMENT_URL = "/api/reservation";
}
